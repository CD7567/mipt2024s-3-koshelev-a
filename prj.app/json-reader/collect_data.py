...
BASE_DATA_DIR = f'{sys.path[0]}/../../prj.data/json-reader'
...
runners = [
    [
        f'{sys.path[0]}/../../cmake-build-release/prj.app/json-reader',
...
def print_table(df: pandas.DataFrame, df_nowrite: pandas.DataFrame):
    data = [
        {
            "mode": "write",
...
print("SMALL")
print_table(df_small, df_small_nowrite)
print("MEDIUM")
print_table(df_medium, df_medium_nowrite)
