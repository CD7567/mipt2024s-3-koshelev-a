...
- [ ] Организовать парсинг при помощи сторонней библиотеки (выбрана `nlohmann::json`)
- [ ] Написать DOM парсер с поточным cpp-style чтением файла
- [ ] Написать DOM парсер с чтением в буфер и сдвигами
- [ ] Сравнить время парсинга для заранее определенного json